export const ALL_TITLES = [
  ...
  { id: "Chí Tôn Kiếm Ma", isCustom: true, desc: "Danh hiệu bí ẩn, siêu hiếm. Đổi thưởng từ Chợ Vật Phẩm với mức giá đắt đỏ. Hiệu ứng: 7 màu luân hồi." },
