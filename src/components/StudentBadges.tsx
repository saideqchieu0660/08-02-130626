...
const BADGES = [
  ...
  // 2. LINH THẠCH TÍCH LŨY (XP / Points)
  {
    ...
    desc: 'Đột phá tích lũy 100 Linh Thạch',
    req: 100,
    icon: Book,
    color: 'text-blue-500',
    bg: 'bg-blue-500/10',
  ...
  },
  {
    ...
    desc: 'Đột phá tích lũy 500 Linh Thạch dồi dào',
    req: 500,
    icon: Star,
    color: 'text-yellow-500',
    bg: 'bg-yellow-500/10',
  ...
  },
  {
    ...
    desc: 'Giữ mực đạt tới 1,000 Linh Thạch',
    req: 1000,
    icon: Award,
  ...
  {
    id: 'stoic',
    name: 'Tối Thượng Chí Tôn',
    desc: 'Tu luyện đỉnh cao gom 5,000 Linh Thạch',
    req: 5000,
    icon: Shield,
                    ...
                    <div className="flex gap-2">
                        ...
                        {unlocked && (
                          <button
                             ...
                             title="Xuất sắc phong Linh Ấn PNG"
                          >
...
export const StudentBadges = ({ 
  ...
  const categories = [
    ...
    { id: "points" as const, label: "Linh Thạch 💎", desc: "Tích lũy" },
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 border-b border-stone-200/50 dark:border-zinc-800/80 pb-6">
         ...
         <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 max-w-4xl w-full xl:w-auto">
            <div className="px-3.5 py-2.5 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-700 dark:text-blue-400 text-xs font-black flex flex-col justify-center items-center gap-0.5 text-center shadow-inner">
               <span className="opacity-65 font-medium">Linh Thạch</span>
